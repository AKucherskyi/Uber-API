...
router.post("/", verifyToken, checkShipperRole,  controller.addLoad);
router.get("/", verifyToken,  controller.getLoads);
router.get("/active", verifyToken, checkDriverRole,  controller.getActiveLoad);
router.patch("/active/state", verifyToken, checkDriverRole,  controller.iterateLoadState);
...
router.get("/:id/shipping_info", verifyToken, checkShipperRole,  controller.getLoadInfo);
